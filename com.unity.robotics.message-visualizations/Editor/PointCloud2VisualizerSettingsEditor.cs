        ...
        if (m_Config.UseRgbChannel)
        {
            ...
            switch (m_Config.ColorModeSetting)
            {
                ...
                case PointCloud2VisualizerSettings.ColorMode.RGB:
                    ...
                    CreateMinMaxSlider(ref configRRange, colorMinVal, colorMaxVal);
                    ...
                    CreateMinMaxSlider(ref configGRange, colorMinVal, colorMaxVal);
                    ...
                    CreateMinMaxSlider(ref configBRange, colorMinVal, colorMaxVal);
