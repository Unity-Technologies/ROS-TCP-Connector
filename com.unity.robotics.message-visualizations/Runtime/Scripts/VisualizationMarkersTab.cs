...
public class VisualizationMarkersTab : IHudTab
{
    ...
    public VisualizationMarkersTab(ROSConnection ros)
    {
        ros.Subscribe<MarkerMsg>("visualization_marker", OnMarker);
        ros.Subscribe<MarkerArrayMsg>("visualization_marker_array", OnMarkerArray);
    }
