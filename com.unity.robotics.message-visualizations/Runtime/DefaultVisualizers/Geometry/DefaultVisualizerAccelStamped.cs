...
public class DefaultVisualizerAccelStamped : DrawingVisualFactory<MAccelStamped>
{
    ...
    public override Action CreateGUI(MAccelStamped message, MessageMetadata meta) => () =>
    {
        message.header.GUI();
        message.accel.GUI();
    };
