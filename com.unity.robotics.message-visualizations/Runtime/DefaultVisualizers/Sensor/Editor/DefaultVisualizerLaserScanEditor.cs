...
public class LaserScanEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (config == null)
        {
            config = (LaserScanVisualizerSettings)AssetDatabase.LoadAssetAtPath("Packages/com.unity.robotics.message-visualizations/Runtime/DefaultVisualizers/Sensor/ScriptableObjects/LaserScanVisualizerSettings.asset", typeof(LaserScanVisualizerSettings));
        }
