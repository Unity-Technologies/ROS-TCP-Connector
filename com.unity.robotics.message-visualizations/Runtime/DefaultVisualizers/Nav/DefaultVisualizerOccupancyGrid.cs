...
public class DefaultVisualizerOccupancyGrid : DrawingTextureVisualFactory<OccupancyGridMsg>
{
    int m_Height;
    int m_Width;
    ...
    public override void Draw(BasicDrawing drawing, OccupancyGridMsg message, MessageMetadata meta)
    {
        ...
        if (state.WindowContents != null)
        {
            ...
            visual.drawingObject = drawing.DrawMesh(visual.mesh, origin - rotation * new Vector3(scale * 0.5f, 0, scale * 0.5f), rotation,
