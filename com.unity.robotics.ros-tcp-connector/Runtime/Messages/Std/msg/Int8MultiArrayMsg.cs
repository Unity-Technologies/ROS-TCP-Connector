...
namespace RosMessageTypes.Std
{
    ...
    public class Int8MultiArrayMsg : Message
    {
        ...
        public Int8MultiArrayMsg(MessageDeserializer deserializer)
        {
        ...
        public static Int8MultiArrayMsg Deserialize(MessageDeserializer deserializer)
        {
            return new Int8MultiArrayMsg(deserializer);
        }
