...
namespace RosMessageTypes.Std
{
    ...
    public class UInt32MultiArrayMsg : Message
    {
        ...
        public UInt32MultiArrayMsg(MessageDeserializer deserializer)
        {
        ...
        public static UInt32MultiArrayMsg Deserialize(MessageDeserializer deserializer)
        {
            return new UInt32MultiArrayMsg(deserializer);
        }
