...
{
    [Serializable]
    public class UInt8MultiArrayMsg : Message
    {
        public const string k_RosMessageName = "std_msgs/UInt8MultiArray";
        ...
        public UInt8MultiArrayMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "UInt8MultiArrayMsg: " +
            "\nlayout: " + layout.ToString() +
            "\ndata: " + System.String.Join(", ", data.ToList());
        }

        public static UInt8MultiArrayMsg Deserialize(MessageDeserializer deserializer)
        {
            return new UInt8MultiArrayMsg(deserializer);
        }
