...
namespace RosMessageTypes.Std
{
    ...
    public class UInt64Msg : Message
    {
        ...
        public UInt64Msg(MessageDeserializer deserializer)
        {
        ...
        public static UInt64Msg Deserialize(MessageDeserializer deserializer)
        {
            return new UInt64Msg(deserializer);
        }
