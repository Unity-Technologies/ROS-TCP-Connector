...
namespace Unity.Robotics.ROSTCPConnector.MessageGeneration
{
    ...
    public class ActionWrapper
    {
        ...
        {
            string function = "";
            function += MsgAutoGenUtilities.TWO_TABS + "public override int AddSerializationStatements(int curOffset, List<byte[]> listOfSerializations)\n";
            ...
            {
                function += TWO_TABS + ONE_TAB + "curOffset = this." + paramName + ".AddSerializationStatements(curOffset, listOfSerializations);\n";
            }

            foreach (string identifier in symbolTable.Keys)
            {
                function += TWO_TABS + ONE_TAB + "curOffset = this." + identifier + ".AddSerializationStatements(curOffset, listOfSerializations);\n";
            }

            function += "\n" + MsgAutoGenUtilities.TWO_TABS + MsgAutoGenUtilities.ONE_TAB + "return curOffset;\n";
            function += MsgAutoGenUtilities.TWO_TABS + "}\n\n";
