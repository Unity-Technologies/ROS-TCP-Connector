...
class UnityTcpSender:
    ...
    def send_unity_error(self, error):
        ros_error = RosUnityError()
        ros_error.message = error
        self.send_unity_message("__error", ros_error)
    ...
    def send_unity_service(self, topic, service_class, request):
        ...
        srv_message = RosUnitySrvMessage(srv_id=srv_id, is_request=True, topic=topic, payload=payload)
